...
class Defender:
    ...
    def __init__(self, ansible_runner, openstack_conn, elasticsearch_conn, external_ip, elasticsearch_port, elasticsearch_api_key, arsenal: Arsenal):
        ...
        self.orchestrator = OpenstackOrchestrator(
            openstack_conn, ansible_runner, self.external_elasticsearch_server, self.elasticsearch_api_key)

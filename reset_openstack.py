...
class OpenstackResetter():
    def __init__(self, config_name = "default") -> None:
        self.cli = openstack.connect(cloud=config_name)
    ...
    def list_instances(self):
        all_servers = self.cli.list_servers()
        print("")
        print("Instances:")
    ...
    def list_floating_ips(self):
        all_floating_ips = self.cli.list_floating_ips()
        print("")
        print("Floating IPs:")
    ...
    def list_subnets(self):
        all_subnets = self.cli.list_subnets()
        print("")
        print("Subnets:")
    ...
    def list_networks(self):
        all_networks = self.cli.list_networks()
        print("")
        print("Networks:")
    ...
    def list_sec_groups(self):
        all_sec_groups = self.cli.list_security_groups()
        print("")
    ...
    def delete_instances(self):
        ...
        for server in all_servers:
            ...
            self.cli.delete_server(server.id)
    ...
    def release_floating_ips(self):
        ...
        for ip in all_floating_ips:
            ...
            self.cli.delete_floating_ip(ip.id)
    ...
    def delete_interfaces(self, router):
        ...
        for interface in all_interfaces:
            ...
            for fixed_ip in interface.fixed_ips:
                self.cli.remove_router_interface(router, subnet_id=fixed_ip['subnet_id'])
    ...
    def delete_routers(self):
        ...
        for router in all_routers:
            ...
            self.cli.delete_router(router.id)
    ...
    def delete_subnets(self):
        ...
        for subnet in all_subnets:
            ...
            self.cli.delete_subnet(subnet.id)
    ...
    def delete_networks(self):
        ...
        for network in all_networks:
            ...
            self.cli.delete_network(network.id)
    ...
    def delete_sec_groups(self):
        ...
        for sec_group in all_sec_groups:
            ...
            self.cli.delete_security_group(sec_group.id)
